...
public class Main {
	...
	public static void main(String args[]) {
		...
		while(!selectedOption.equals("0")){
			...
			switch(selectedOption) {
				...
				case "4":
					System.out.println("Elige tipo de tri�ngulo: 1)Equil�tero 2)Escaleno 3)Isosceles");
					switch(sc.nextInt()){
						case 1: 
	...
	public static String preguntarFigura(Scanner sc) {
		System.out.println("Elige la figura: 1)Cuadrado 2)C�rculo 3)Rectangulo 4) tri�ngulo 5)Tetraedro");
